...
class TestRegistryConfig(TransactionCase):
    ...
    def test_delete_id_type_updates_config(self):
        ...
        updated_id_types_param = ir_config.get_param("g2p_registry_id_deduplication.ind_deduplication_id_types_ids")
    ...
    def test_set_values_empty_ids(self):
        ...
        ir_config = self.env["ir.config_parameter"].sudo()
        grp_id_types_param = ir_config.get_param("g2p_registry_id_deduplication.grp_deduplication_id_types_ids")
        ind_id_types_param = ir_config.get_param("g2p_registry_id_deduplication.ind_deduplication_id_types_ids")
    ...
    def test_unlink_id_type_with_no_references(self):
        ...
        self.assertFalse(self.id_type_model.browse(new_id_type.id).exists(), "New ID Type should not exist after unlinking.")
